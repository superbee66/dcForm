...
namespace dCForm
{
    ...
    public class LightDoc : IDocLogistics, IDocIdentifiers, IComparable<LightDoc>
    {
        ...
        /// </summary>
        [ScriptIgnore]
        public string DataKeyField { get { return JsonConvert.SerializeObject(this); } }
        ...
        public static LightDoc FromObject(object o)
        {
            ...
            return (LightDoc)JsonConvert.DeserializeObject(
        ...
        /// <returns></returns>
        public static LightDoc Parse(string Json) { return JsonConvert.DeserializeObject<LightDoc>(Json); }
    }
}