    ...
    public static class ImporterController
    {
        ...
        public static List<ImporterLightDoc> ImportDocModels(string DocTypeName = null)
        {
                ...
                )
            {
                ...
                // always (over)write the xsd as this will always be generated by and for dCForm regardless of the IDocInterpreter that is handling
