...
namespace dCForm.Storage.Sql
{
    ...
    public abstract class SqlDbContext : DbContext
    {
        ...
        public const string CREATE_INSTANCE_TEMPLATE = @"
            namespace {0} {{
                public class {1} : dCForm.Storage.Sql.SqlDbContext {{
                    public {1}() : base( ) {{
                        System.Data.Entity.Database.SetInitializer(new System.Data.Entity.MigrateDatabaseToLatestVersion<{0}.{1}, dCForm.Storage.Sql.SqlDbMigrationsConfiguration<{0}.{1}>>());
                    }}
                }}
            }}";
