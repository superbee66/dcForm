...
namespace dCForm.Storage.Sql
{
    ...
    public class SqlDB : MetaModel, IDisposable
    {
        ...
        private static readonly Dictionary<string, SqlDB> SqlDbDictionary = new Dictionary<string, SqlDB>();
        ...
        public void Dispose()
        {
            string key = SqlDbDictionary.First(m => m.Value == this).Key;
            SqlDbDictionary.Remove(key);
