...
namespace dCForm.Core.Util
{
    public static class Reflection
    {
        ...
        /// <summary>
        ///     Searches the appdomain for a matching type to activate. Stores the activated object in cache.
        /// </summary>
        /// <param name="typeName"></param>
        /// <param name="typeNamespace"></param>
        /// <param name="assemblyName">Current AppDomain loaded assemblies will be searched by default</param>
        /// <returns>A copy of first (shotgun method) matching object type sought after; created by its default constructor</returns>
        public static object CreateObject(string typeName, string typeNamespace = null, string assemblyName = null)
        {
        ...
        /// </summary>
        public static void LoadBinDlls()
        {
            foreach (FileInfo fileInfo in Directory.EnumerateFiles(
                ...
                AppDomain.CurrentDomain.Load(fileInfo.Name.Substring(0, fileInfo.Name.LastIndexOf('.')));
        }
    }
}